...
public class Data {
    ...
    private void initializeSampleData() {
        ...
        createComment(15, 1, "Tối ưu hóa tốc độ tải trang đã thành công.","2024-11-15");
        createComment(16, 2, "Đã hoàn thành kiểm thử chức năng đăng nhập và bảo mật, yêu cầu phê duyệt.", "2024-11-16");
        createComment(17, 3, "Tính năng quản lý đơn hàng đang được kiểm thử, dự kiến sẽ hoàn thành trong tuần tới.", "2024-11-17");
        createComment(18, 4, "Chức năng phân tích báo cáo tài chính đã hoàn thiện, cần kiểm thử với các dữ liệu thực tế.", "2024-11-18");
        createComment(19, 5, "Giao diện người dùng của ứng dụng bán vé máy bay đã được cải thiện, cần phản hồi.", "2024-11-19");
        createComment(20, 6, "Tính năng tìm kiếm vé máy bay đang được thử nghiệm, hiệu suất khá ổn.", "2024-11-20");
        createComment(21, 7, "Tạo báo cáo tài chính cho tháng 11 đã hoàn thành, cần kiểm tra một số chỉ tiêu mới.", "2024-11-21");
        createComment(22, 8, "Đã cập nhật các tính năng mới cho CRM, cần thử nghiệm với các dữ liệu đầu vào khác nhau.", "2024-11-22");
        createComment(23, 9, "Công cụ tự động hóa marketing đã sẵn sàng, đang tiến hành kiểm thử với các chiến dịch mẫu.", "2024-11-23");
        createComment(24, 10, "Tính năng quản lý người dùng trong ứng dụng bán hàng đã hoàn thiện, đang trong giai đoạn kiểm thử.", "2024-11-24");
        createComment(25, 11, "Lỗi bảo mật trong hệ thống thanh toán đã được khắc phục, cần thử nghiệm với dữ liệu thực tế.", "2024-11-25");
        createComment(26, 12, "Cập nhật API cho ứng dụng bán vé đã hoàn thành, cần thử nghiệm với dữ liệu người dùng thực.", "2024-11-26");
        createComment(27, 13, "Chức năng thanh toán trực tuyến đã được cải tiến, tiến hành kiểm thử trong các kịch bản sử dụng khác nhau.", "2024-11-27");
        createComment(28, 14, "Giao diện người dùng của hệ thống quản lý kho đã được cập nhật, yêu cầu phản hồi từ nhóm kiểm thử.", "2024-11-28");
        createComment(29, 15, "Chức năng báo cáo tài chính đã được hoàn thiện, đang trong giai đoạn thử nghiệm cuối cùng.", "2024-11-29");
        createComment(30, 1, "Đã triển khai và kiểm thử thành công tính năng tìm kiếm trong hệ thống bán vé, hiệu suất đã được cải thiện.", "2024-11-30");
        createComment(1, 2, "Báo cáo tài chính tháng 11 đã hoàn thành, đang gửi cho nhóm quản lý để xem xét.", "2024-12-01");
        createComment(2, 3, "Đã hoàn thành việc kiểm thử hệ thống thanh toán, có thể triển khai lên môi trường sản xuất.", "2024-12-02");
        createComment(3, 4, "Chức năng tìm kiếm vé máy bay đã được hoàn thiện, chờ triển khai vào ngày mai.", "2024-12-03");
        createComment(4, 5, "Các báo cáo tài chính đã được cập nhật đầy đủ, sẽ đưa vào hệ thống kiểm thử vào tuần tới.", "2024-12-04");
        createComment(5, 6, "Các tính năng bảo mật trong hệ thống thanh toán đã được nâng cấp, cần triển khai kiểm thử trong môi trường thực tế.", "2024-12-05");
        createComment(6, 7, "Chức năng báo cáo tài chính đã được hoàn thành, đang chờ phê duyệt từ nhóm kiểm thử.", "2024-12-06");
        createComment(7, 8, "Cập nhật API cho hệ thống bán vé đã xong, đang kiểm tra các tính năng đã được triển khai.", "2024-12-07");
        createComment(8,9, "Chức năng tự động hóa marketing đã được hoàn thiện, đang kiểm thử trong các chiến dịch nhỏ.", "2024-12-08");
        createComment(9, 10, "Đã hoàn thành việc cải tiến tốc độ tải trang, tiến hành thử nghiệm và đánh giá hiệu suất.", "2024-12-09");
        createComment(10, 11, "Chức năng quản lý kho hàng đã được cài đặt và thử nghiệm thành công, đang triển khai lên môi trường thực.", "2024-12-10");
        createComment(11, 12, "Hệ thống tìm kiếm trong ứng dụng bán vé đã được hoàn thiện, đang trong giai đoạn kiểm thử cuối cùng.", "2024-12-11");
        createComment(12, 13, "Tính năng báo cáo tài chính cho doanh nghiệp đã được cải tiến, cần triển khai vào tháng tới.", "2024-12-12");
        createComment(13, 14, "Hệ thống thanh toán đã được kiểm tra và cập nhật, dự kiến triển khai vào tuần tới.", "2024-12-13");
        createComment(14, 15, "Cải tiến hệ thống đăng nhập và bảo mật đã được hoàn thành, cần thử nghiệm trong các điều kiện môi trường thực tế.", "2024-12-14");
        createComment(15, 1, "Tính năng quản lý đánh giá khách hàng đã được triển khai, cần kiểm thử với một số chiến dịch mẫu.", "2024-12-15");
        createComment(16, 2, "Ứng dụng bán vé máy bay đã cập nhật hệ thống thanh toán, cần triển khai kiểm thử toàn diện.", "2024-12-16");
        createComment(17, 3, "Hệ thống báo cáo tài chính đã hoàn tất và đang trong giai đoạn triển khai.", "2024-12-17");
        createComment(18, 4, "Chức năng tự động hóa marketing đã được tích hợp thành công, dự kiến triển khai trong tuần tới.", "2024-12-18");
        createComment(19, 5, "Đã hoàn thành kiểm thử bảo mật cho hệ thống thanh toán, hiệu suất hoạt động ổn định.", "2024-12-19");
        createComment(20, 6, "Ứng dụng bán vé máy bay đã được kiểm thử xong, tiến hành triển khai lên môi trường sản xuất.", "2024-12-20");
...
// Các người dùng còn lại tham gia dự án với vai trò "Member"
        ...
        projectUsers.add(new ProjectUser(12, 5, "Member"));
        projectUsers.add(new ProjectUser(13, 7, "Member"));
        projectUsers.add(new ProjectUser(14, 8, "Member"));
        projectUsers.add(new ProjectUser(15, 9, "Member"));
        projectUsers.add(new ProjectUser(16, 10, "Member"));
        ...
        projectUsers.add(new ProjectUser(8, 6, "Member"));
        projectUsers.add(new ProjectUser(9, 7, "Member"));
        projectUsers.add(new ProjectUser(10, 8, "Member"));
        projectUsers.add(new ProjectUser(11, 9, "Member"));
        projectUsers.add(new ProjectUser(12, 10, "Member"));
